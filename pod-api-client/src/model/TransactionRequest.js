...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PodApiClient.TransactionRequest = factory(root.PodApiClient.ApiClient, root.PodApiClient.LineItem);
  }
   ...
   * @param transactionStatus {String} Status. Only \"APPROVED\" staus is accepted at the moment.
   * @param lineItems {Array.<module:model/LineItem>} 
   */
  var exports = function(financierId, contractId, totalAmount, currency, transactionReference, transactionDate, source, transactionStatus, lineItems) {
    var _this = this;
  ...
  /**
   * Status. Only \"APPROVED\" staus is accepted at the moment.
