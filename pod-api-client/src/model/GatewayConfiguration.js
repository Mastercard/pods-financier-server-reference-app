...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PodApiClient.GatewayConfiguration = factory(root.PodApiClient.ApiClient);
  }
  ...
  /**
   * The GatewayConfiguration model module.
   * @module model/GatewayConfiguration
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GatewayConfiguration</code>.
   * @alias module:model/GatewayConfiguration
   * @class
   * @param gatewayConfigurationId {String} ID.
   * @param configuration {String} Configuration for financier. This is JSON format.
   * @param financierId {String} Financier ID that owns this configuration.
   * @param gatewayId {String} Gateway ID.
   */
  var exports = function(gatewayConfigurationId, configuration, financierId, gatewayId) {
    var _this = this;

    _this['gatewayConfigurationId'] = gatewayConfigurationId;
  ...
  /**
   * Constructs a <code>GatewayConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GatewayConfiguration} obj Optional instance to populate.
   * @return {module:model/GatewayConfiguration} The populated <code>GatewayConfiguration</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('gatewayConfigurationId')) {
        obj['gatewayConfigurationId'] = ApiClient.convertToType(data['gatewayConfigurationId'], 'String');
      }
  ...
  /**
   * ID.
   * @member {String} gatewayConfigurationId
   */
  exports.prototype['gatewayConfigurationId'] = undefined;
  /**
   * Configuration for financier. This is JSON format.
