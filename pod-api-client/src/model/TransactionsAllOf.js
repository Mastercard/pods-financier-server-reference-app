...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PodApiClient.TransactionsAllOf = factory(root.PodApiClient.ApiClient, root.PodApiClient.Transaction);
  }
  ...
  /**
   * The TransactionsAllOf model module.
   * @module model/TransactionsAllOf
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TransactionsAllOf</code>.
   * @alias module:model/TransactionsAllOf
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionsAllOf</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionsAllOf} obj Optional instance to populate.
   * @return {module:model/TransactionsAllOf} The populated <code>TransactionsAllOf</code> instance.
   */
