...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.Gateways();
  });
  ...
  describe('Gateways', function() {
    it('should create an instance of Gateways', function() {
      ...
      var instance = new PodApiClient.Gateways();
      expect(instance).to.be.a(PodApiClient.Gateways);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.Gateways(0, 5, []);
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.Gateways.constructFromObject({});
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.Gateways.constructFromObject(
        {
          count: 10,
          offset: 0,
          limit: 5,
