...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function () {
    it('should create an instance of ErrorResponse', function () {
      ...
      var instance = new PodApiClient.ErrorResponse();
      expect(instance).to.be.a(PodApiClient.ErrorResponse);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.ErrorResponse([]);
      expect(instance).to.have.property('Errors');
    });

    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.ErrorResponse.constructFromObject({});
      expect(instance).to.have.property('Errors');
    });

    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.ErrorResponse.constructFromObject(
        {
          Errors: [],
        },
        instance
