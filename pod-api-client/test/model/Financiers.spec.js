...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.Financiers();
  });
  ...
  describe('Financiers', function () {
    it('should create an instance of Financiers', function () {
      // uncomment below and update the code to test Financiers
      var instance = new PodApiClient.Financiers();
      expect(instance).to.be.a(PodApiClient.Financiers);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.Financiers(0, 5, []);
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.Financiers.constructFromObject({});
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.Financiers.constructFromObject(
        {
          count: 10,
          offset: 0,
          limit: 5,
