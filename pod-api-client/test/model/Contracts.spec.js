...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.Contracts();
  });
  ...
  describe('Contracts', function () {
    it('should create an instance of Contracts', function () {
      ...
      var instance = new PodApiClient.Contracts();
      expect(instance).to.be.a(PodApiClient.Contracts);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.Contracts(0, 5, []);
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.Contracts.constructFromObject({});
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.Contracts.constructFromObject(
        {
          count: 10,
          offset: 0,
          limit: 5,
