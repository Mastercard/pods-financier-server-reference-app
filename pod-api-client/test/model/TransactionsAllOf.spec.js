...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.TransactionsAllOf();
  });
  ...
  describe('TransactionsAllOf', function() {
    it('should create an instance of TransactionsAllOf', function() {
      // uncomment below and update the code to test TransactionsAllOf
      var instance = new PodApiClient.TransactionsAllOf();
      expect(instance).to.be.a(PodApiClient.TransactionsAllOf);
    });
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.TransactionsAllOf.constructFromObject({});
      expect(instance).to.have.property('items');
    });

    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.TransactionsAllOf.constructFromObject(
        {
          items: [],
        },
        instance
