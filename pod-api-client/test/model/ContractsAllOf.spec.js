...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.ContractsAllOf();
  });
  ...
  describe('ContractsAllOf', function () {
    it('should create an instance of ContractsAllOf', function () {
      // uncomment below and update the code to test ContractsAllOf
      var instance = new PodApiClient.ContractsAllOf();
      expect(instance).to.be.a(PodApiClient.ContractsAllOf);
    });
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.ContractsAllOf.constructFromObject({});
      expect(instance).to.have.property('items');
    });

    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.ContractsAllOf.constructFromObject(
        {
          items: [],
        },
        instance
