...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.GatewayConfigurationWeb();
  });
  ...
  describe('GatewayConfigurationWeb', function() {
    it('should create an instance of GatewayConfigurationWeb', function() {
      // uncomment below and update the code to test GatewayConfigurationWeb
      //var instance = new PodApiClient.GatewayConfigurationWeb();
      //expect(instance).to.be.a(PodApiClient.GatewayConfigurationWeb);
    });
