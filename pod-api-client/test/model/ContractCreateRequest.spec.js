...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.ContractCreateRequest();
  });
  ...
  describe('ContractCreateRequest', function () {
    it('should create an instance of ContractCreateRequest', function () {
      // uncomment below and update the code to test ContractCreateRequest
      var instance = new PodApiClient.ContractCreateRequest();
      expect(instance).to.be.a(PodApiClient.ContractCreateRequest);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.ContractCreateRequest(
        '599',
        'SGD',
        '20',
        '24',
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.ContractCreateRequest.constructFromObject(
        {}
      );
      expect(instance).to.have.property('amount');
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.ContractCreateRequest.constructFromObject(
        {
          amount: 599,
          currency: 'SGD',
