...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.ContractDeviceCreateRequest();
  });
  ...
  describe('ContractDeviceCreateRequest', function () {
    it('should create an instance of ContractDeviceCreateRequest', function () {
      // uncomment below and update the code to test ContractDeviceCreateRequest
      var instance = new PodApiClient.ContractDeviceCreateRequest();
      expect(instance).to.be.a(PodApiClient.ContractDeviceCreateRequest);
    });
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.ContractDeviceCreateRequest.constructFromObject(
        {}
      );
      expect(instance).to.be.a(PodApiClient.ContractDeviceCreateRequest);
    });
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.ContractDeviceCreateRequest.constructFromObject(
        {
          deviceIMEI: 'IMEI',
        },
        instance
