...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.FinanciersAllOf();
  });
  ...
  describe('FinanciersAllOf', function() {
    it('should create an instance of FinanciersAllOf', function() {
      // uncomment below and update the code to test FinanciersAllOf
      var instance = new PodApiClient.FinanciersAllOf();
      expect(instance).to.be.a(PodApiClient.FinanciersAllOf);
    });
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.FinanciersAllOf.constructFromObject({});
      expect(instance).to.have.property('items');
    });

    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.FinanciersAllOf.constructFromObject(
        {
          items: [],
        },
        instance
