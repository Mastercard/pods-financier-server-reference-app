...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.GatewaysAllOf();
  });
  ...
  describe('GatewaysAllOf', function () {
    it('should create an instance of GatewaysAllOf', function () {
      // uncomment below and update the code to test GatewaysAllOf
      var instance = new PodApiClient.GatewaysAllOf();
      expect(instance).to.be.a(PodApiClient.GatewaysAllOf);
    });
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.GatewaysAllOf.constructFromObject({});
      expect(instance).to.have.property('items');
    });

    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.GatewaysAllOf.constructFromObject(
        {
          items: [],
        },
        instance
