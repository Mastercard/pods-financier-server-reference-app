...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new PodApiClient.Transactions();
  });
  ...
  describe('Transactions', function () {
    it('should create an instance of Transactions', function () {
      ...
      var instance = new PodApiClient.Transactions();
      expect(instance).to.be.a(PodApiClient.Transactions);
    });
    ...
    it('should copy from constructor argument', function () {
      const instance = new PodApiClient.Transactions(0, 5, []);
    ...
    it('should copy to provided object even for empty data', function () {
      const instance = PodApiClient.Transactions.constructFromObject({});
    ...
    it('should copy to provided object', function () {
      const instance = {};
      PodApiClient.Transactions.constructFromObject(
        {
          count: 10,
          offset: 0,
          limit: 5,
