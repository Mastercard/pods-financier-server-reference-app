...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.PaymentSessionsApi();
  });
  ...
  describe('PaymentSessionsApi', function() {
    describe('createPaymentSession', function() {
      it('should call createPaymentSession successfully', function(done) {
        //uncomment below and update the code to test createPaymentSession
        //instance.createPaymentSession(function(error) {
