...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PodApiClient.GatewayApi();
  });
  ...
  describe('GatewayApi', function() {
    describe('getGateways', function() {
      it('should call getGateways successfully', function(done) {
        //uncomment below and update the code to test getGateways
        //instance.getGateways(function(error) {
